...
In this class, we use the phrases _statistical learning_, _machine learning_, or _learning_ interchangeably.
...
- Outcome $Y$ (also called output, response variable, dependent variable, target).
    - In the _regression problem_, $Y$ is quantitative (price, weight, bmi).  
    - In the _classification problem_, $Y$ is categorical. That is $Y$ takes values in a finite, unordered set (survived/died, digit 0-9, object in image, cancer class of tissue sample).  
...
g = sns.FacetGrid(Smarket_long, col = "Lag", col_wrap = 3)
...
::: {#fig-handwritten-digits layout-ncol=1}

![](./ISL_fig_10_3a.pdf){fig-align="center" width=80%}

![](./ISL_fig_10_3b.pdf){fig-align="center" width=80%}
...
![](./ESL_fig_13_6.pdf){fig-align="center"}
