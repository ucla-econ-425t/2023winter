...
- Prediction. With a good estiamte $\hat f$, we can predict $Y$ at new points $X = x$
$$
\hat Y = \hat f (X).
$$
...
- Inference. 
    ...
    - Causal inference. We may infer whether purposedly changing the values of certain predictors will change outcomes. We rely on various learning methods to estimate $f$.
