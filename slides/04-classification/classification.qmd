...
<p align="center">
![](ISL_fig_4_6.pdf){width=500px height=350px}
</p>
...
<p align="center">
![](ISL_fig_4_9.pdf){width=600px height=350px}
</p>
...
for idx, m in enumerate(classifiers):
  plt.figure()
  roc_display = RocCurveDisplay.from_estimator(m, X, y, name = sm_df.iloc[idx].name)
  plt.show()
```
