...
I don't know of good Python packages for best subset regression. The [`abess`](https://abess.readthedocs.io/en/latest/index.html) package may be worth trying. Please see the R code.
...
- $C_p$, AIC and BIC have rigorous theoretical justification. As sample size $n$ is very large, they are guaranteed to find the best model. Adjusted $R^2$ is less motivated in statistical theory.
