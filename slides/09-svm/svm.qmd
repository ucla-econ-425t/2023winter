...
$$
Thus $f(x)$ is proportional to the signed distance from $x$ to the hyperplane defined by $f(x) = 0$.
...
[Workflow: SVM with polynomial kernel](https://ucla-econ-425t.github.io/2023winter/slides/09-svm/workflow_svm_poly.html)

[Workflow: SVM with radial kernel](https://ucla-econ-425t.github.io/2023winter/slides/09-svm/workflow_svm_rbf.html)
