...
\begin{eqnarray*}
\min & & \frac 12 \|\beta\|^2 \\
\text{subject to} & & y_i(\beta_0 + \beta^T x) \ge 1 - \xi_i, \quad i=1,\ldots,n \\
...
computes the inner products needed for $d$-dimensional polynomials.
    ...
    For example, when degree $d=2$ and $p=2$ features, 
\begin{eqnarray*}
...
[Workflow: SVM](https://ucla-econ-425t.github.io/2023winter/slides/09-svm/workflow_svm.html)
