...
tuner = keras_tuner.RandomSearch(
    ...
    objective = "val_auc_score", # val_accuracy
    max_trials = 10,
...
We can also print a summary of the search results.
```{python}
...
If we want to train the model with the entire dataset, we may retrieve the best hyperparameters and retrain the model by ourself.
```{python}
